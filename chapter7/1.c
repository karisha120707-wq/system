...
char *ADS [] = {
    ...
    "Мэтью: одинокий мужчина, европеец, некурящий, любит живопись, кино, театр",
    "Луис: одинокий мужчина, латиноамериканец, непьющий, любит грузовики спорт и Джастина Бибера",
